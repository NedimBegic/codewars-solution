...
or 3044. His parents can't keep up calculating this so they've begged you to help them out by writing a programme 
...
const  calculateAge = (x,y) => {
    if(y-x==1) return "You are 1 year old."
    else if(x<y) return `You are ${y-x} years old.`;
    else if (x-y==1) return "You will be born in 1 year."
    else if (x>y) return `You will be born in ${x-y} years.`;
    else if (x==y) return "You were born this very year!";
  }